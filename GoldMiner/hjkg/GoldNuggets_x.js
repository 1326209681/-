...
var cw = dsp[gg];
var dP = dsp[fX];
var aP ='http://www.zzfriend.com/demo/youxi/m/hjkg/?'; //'http://' + dX + '/games/' + bs + '/' + bs + '.php?pid' + eQ;
var g = 0;
var f = 2;
var cA = 0;
var cD = 1;
...
var aN2 = "position:absolute;top:0px;left:0px;z-Index:0;";
...
if (aW) {
    ...
    if (dO)
        ah = ds_urlhiscore + dY;
    document.write('<img id=\'hi\' style=\'' + aN + 'opacity:0;-moz-opacity:0.6;filter:alpha(opacity=60);\' ' + Q + '=\'fl()\' src=\'' + bY + '\' >');
}
...
document.write('<img id=\'overImg\' style=\'' + aN2 + '\' src=\'' + 'gameOver.jpg' + '\' width=' + r + ' height=' + D + '>');
if (eN) {
}
...
if ((g == ae) || (g == at))
    eg('en', "7f4f00");
document.write('<div id=\'t1\' style=\'' + bq + 'opacity: 0;color:#ffffff;font-family:Arial;font-size:' + (42 * f) + 'px;text-shadow: 2px 2px 2px #000000;\'></div>');
...
document.write('<img id=\'ti\' style=\'position:absolute;top:0px;left:0px;visibility:visible;z-Index:1;opacity:1;-webkit-transition-property: opacity;-webkit-transition-duration: 1s;\' src=\'' + ds + '\' width=' + r + ' height=' + D + '>');
